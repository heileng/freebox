...
public class VideoConfigActivity extends Activity{
	...
	private final String[] videoShowDriverString={"默认视频显示驱动", "Android 2.x兼容模式", "Java视频显示驱动"};
	private final int[]	videoShowDriverValue={0,4,5};
	
	private final String[] audioPlayDriverString={"默认音频播放驱动", "Java音频播放驱动"};
	private final int[] audioPlayDriverValue={0,3};
	
	private final String[] audioRecordDriverString={"默认音频采集驱动", "Java音频采集驱动"};
	private final int[] audioRecordDriverValue={0,3};	
	
	private final String[] videoCapDriverString={"默认视频采集驱动", "Video4Linux驱动", "Java视频采集驱动"};
